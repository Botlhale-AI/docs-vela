---
sidebar_position: 0
title: How to Conduct Quality Assurance (QA) with Vela
---
...
2.  Use the **Filter options** to narrow the list:
...
1.  Click on the interaction from the Dashboard, Smart Search results, or the Interactions list.
...
2.  Use the **Speed Adjustment** (e.g., 1.5x) to review calls efficiently.
3.  Click on a **Timestamp** in the transcript to jump to that exact moment in the audio/chat.
...
1.  In the transcript, or on the Scorecard, locate the **Comment System**.
