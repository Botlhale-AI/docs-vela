...
- **Smart Search**: monitor every processed interaction for the phrases, keywords, and patterns you define, and raise an alert when they appear.
- **Smart Questions**: ask a yes/no question about each interaction for reporting, without affecting anyone's score.
