...
![Agent portal navigation showing clean, simple layout](../img/screenshots/settings/agent-portal-nav.png)
...
![Awards section showing certificates and achievement badges](../img/screenshots/awards/agent-awards.png)
